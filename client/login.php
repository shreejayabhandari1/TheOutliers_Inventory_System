...
<head>
    ...
    <title>Client Login – StoreHub</title>   
     <style>
...
<div class="auth-page">
    <div class="auth-container">
        ...
        <div class="auth-left">
            <div>
                ...
                <p class="auth-tagline">
                    Browse our electronics catalog.<br>
        ...
        <div class="auth-right">
            <h1>Client Login</h1>
            <p class="subtitle">Sign in to browse products and place orders.</p>

            <?php if ($error): ?>
                <div class="alert alert-error">⚠ <?= htmlspecialchars($error) ?></div>
            <?php endif; ?>

            <form action="/storehub/backend/auth/client_login.php" method="POST"
            ...
            <p class="text-center mt-4 text-sm">
                ...
                <a href="/storehub/client/register.php" style="color:var(--brown-accent);font-weight:600">Register here</a>
            </p>
            <p class="text-center mt-4 text-sm text-muted">
                <a href="/storehub/index.php">Manager login →</a>
            </p>
        </div>
    </div>
</div>
